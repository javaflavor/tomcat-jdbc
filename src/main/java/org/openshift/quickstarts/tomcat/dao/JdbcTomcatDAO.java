...
public class JdbcTomcatDAO implements TomcatDAO {
    ...
    private DataSource lookupDataSource() {
        try {
            ...
            try {
                return (DataSource) initialContext.lookup(DB_JNDI);
//                return (DataSource) initialContext.lookup(System.getenv("DB_JNDI"));
            } catch (NameNotFoundException e) {
                return (DataSource) initialContext.lookup("java:comp/env/"+DB_JNDI);  // Tomcat places datasources inside java:comp/env
